...
class FilewatcherService(CommonSystemTest):
    ...
    def test_list_success_notifications(self):
        ...
        self.expect_recipe_message(
            ...
            recipe_path=[1],
            recipe_pointer=2,
            payload={"file": names[0], "file-index": 1, "file-seen-at": mock.ANY},
            timeout=50,
        )
        ...
        self.expect_recipe_message(
            ...
            recipe_path=[1],
            recipe_pointer=4,
            payload={"file": names[9], "file-index": 10, "file-seen-at": mock.ANY},
            min_wait=63,
            timeout=150,
        )
    ...
    def test_list_failure_notification_immediate(self):
        ...
        self.expect_recipe_message(
            ...
            recipe_path=[1],
            recipe_pointer=8,
            payload={"file": names[0], "file-index": 1, "success": False},
            min_wait=55,
            timeout=90,
        )
    ...
    def test_list_failure_notification_delayed(self):
        ...
        self.expect_recipe_message(
            ...
            recipe_path=[1],
            recipe_pointer=8,
            payload={"file": names[4], "file-index": 5, "success": False},
            min_wait=14,
            timeout=80,
        )
