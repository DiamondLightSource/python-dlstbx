...
console_scripts = [
    ...
    "dlstbx.pandda_array_submit=dlstbx.cli.pandda_array.submit:run",
    "dlstbx.pandda_array_task=dlstbx.cli.pandda_array.task:run",
    ...
    "dlstbx.xchem_collate_run=dlstbx.cli.xchem_collate.run:run",
...
known_wrappers = [  # please keep alphabetically sorted
    ...
    "shelxt = dlstbx.wrapper.shelxt:ShelxtWrapper",
...
mimas_scenario_handlers = [
    ...
    "screening = dlstbx.mimas.core:handle_screening",
