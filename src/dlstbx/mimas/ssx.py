...
type ParamTuple = Tuple[mimas.MimasISPyBParameter, ...]


@mimas.match_specification(is_nexus & is_end & is_serial & is_i24)
def handle_nexus_serial_end(
...
@mimas.match_specification(is_nexus & is_start & is_serial & is_i24)
def handle_nexus_serial_start(
    scenario: mimas.MimasScenario,
    **kwargs,
) -> List[mimas.Invocation]:
    return [
