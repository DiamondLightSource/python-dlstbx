...
class _PayloadIsValidPIAResult(object):
  ...
  def __eq__(self, other):
    ...
    requirements = [
      ...
      { 'name': 'file-number', 'equals': self.recipe['start'][0][1]['file-number'] },
      { 'name': 'file-pattern-index', 'equals': self.recipe['start'][0][1]['file-pattern-index'] },
      ...
      { 'name': 'total_intensity', 'min': self.min_intensity, 'max': self.max_intensity },
    ]
