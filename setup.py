...
known_wrappers = [  # please keep alphabetically sorted
    ...
    "mrbump_setup = dlstbx.wrapper.mrbump:MrBUMPSetupWrapper",
    "mrbump_run = dlstbx.wrapper.mrbump:MrBUMPRunWrapper",
    "mrbump_report = dlstbx.wrapper.mrbump:MrBUMPReportWrapper",
