...
if __name__ == '__main__':
  ...
  parser.add_option("-b", "--beamlime", dest="beamline",
      default=None, help="Name of beamline")
  parser.add_option("-v", "--visit", dest="visit",
      default=None, help="Name of visit")
  parser.add_option("-a", "--application", dest="application",
      default=None, help="Name of application")
  ...
  if options.summary:
    ...
    summaries = []
    for a in ('Grid scan', 'Screening', 'Fast_EP', 'Fast_DP', 'Dimple', 'xia2', 'multi-xia2', 'xia2 3d', 'xia2 3dii'):
  ...
  if options.beamline:
    ...
    beamline = lambda: random.choice([ 'i03', 'i03-1', 'i04', 'i19-1', 'i19-2', 'i23', 'i24' ])
  ...
  if options.application:
    ...
    application = lambda: random.choice([ 'fast_dp', 'fast_ep', 'xia2', 'i19.screen' ])
