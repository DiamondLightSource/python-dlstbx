...
if __name__ == "__main__":
    ...
    for param in options.parameters:
        ...
        if not m:
            fail(
                "'{param}' is not a valid parameter definition. Must follow format KEY=VALUE".format(
                    param=param
                )
            )
...
print()
print(
    "Warning: dlstbx.process is deprecated and will be removed soon. Use ispyb.job instead"
)
