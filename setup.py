...
console_scripts = [
    ...
    "dlstbx.eiger_emulator=dlstbx.cli.:run",
    "dlstbx.eiger_slurper=dlstbx.cli.:run",
    "dlstbx.ep_predict=dlstbx.cli.ep_predict:runmain",
    "dlstbx.ep_predict_phase=dlstbx.cli.:run",
    ...
    "dlstbx.gda_listen=dlstbx.cli.gda_listen:run",
    "dlstbx.gda_write=dlstbx.cli.gda_write:run",
    ...
    "dlstbx.mr_predict_results=dlstbx.cli.:runmain",
