...
console_scripts = [
    ...
    "dlstbx.cluster_monitor_server=dlstbx.cluster_monitor.server:run",
...
known_wrappers = [  # please keep alphabetically sorted
    ...
    "relion_prometheus_metrics = dlstbx.wrapper.relion_prometheus_metrics:RelionPrometheusMetricsWrapper",
...
service_list = [
    ...
    "DLSPromInterface = dlstbx.services.prometheus_interface:DLSPromInterface",
