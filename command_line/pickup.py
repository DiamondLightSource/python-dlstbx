...
parser = OptionParser(usage="dlstbx.pickup [options]",
                      description="Processes dlstbx.go backlog")

parser.add_option("-?", action="help", help=SUPPRESS_HELP)
parser.add_option("-d", "--delay", dest="delay", action="store", type="int", default=2,
    help="Number of seconds to wait between message dispatches")
parser.add_option("-w", "--wait", dest="wait", action="store", type="int", default=60,
