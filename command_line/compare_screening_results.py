...
""" %sessionid
  ...
  plots = ['transmission', 'mosaicity', 'resolution', 'numberOfImages', 'spaceGroup',
           'exposureTime']
  unit_cell = ['unitCell_a', 'unitCell_b', 'unitCell_c',
               'unitCell_alpha', 'unitCell_beta', 'unitCell_gamma']
  for k in ['dataCollectionId', 'programVersion', 'comments', 'shortComments'] + plots + unit_cell:
  ...
  selections['xia2']['native'] = (program_version == 'xia2.strategy') & (short_comments == 'native')
  selections['edna']['native'] = (program_version == 'EDNA MXv1') & (short_comments == 'EDNAStrategy1')
  selections['xia2']['anomalous'] = (program_version == 'xia2.strategy') & (short_comments == 'anomalous')
  selections['edna']['anomalous'] = (program_version == 'EDNA MXv1') & (short_comments == 'EDNAStrategy2')
  selections['xia2']['high multiplicity'] = (program_version == 'xia2.strategy') & (short_comments == 'high multiplicity')
  selections['edna']['high multiplicity'] = (program_version == 'EDNA MXv1') & (short_comments == 'EDNAStrategy3')
  selections['xia2']['gentle'] = (program_version == 'xia2.strategy') & (short_comments == 'gentle')
  selections['edna']['gentle'] = (program_version == 'EDNA MXv1') & (short_comments == 'EDNAStrategy4')
  ...
  for uc in 'abc':
    ...
    lim = (min(ax_scatter.get_xlim()[0], ax_scatter.get_ylim()[0]),
