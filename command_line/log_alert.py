...
if __name__ == '__main__':
  parser = OptionParser(usage="dlstbx.log_alert -n NAME (--pass | --fail) [free text]")
  parser.add_option("-?", action="help", help=SUPPRESS_HELP)
  parser.add_option("-n", "--name", dest="name", default=None, action="store",
                    help="Name of alert to be logged.")
  parser.add_option("--pass", dest="log_pass", default=False, action="store_true",
                    help="Log a success event.")
  parser.add_option("--fail", dest="log_fail", default=False, action="store_true",
