...
def test_that_assessments_are_run_and_services_and_instances_are_created(uu):
  ...
  assert se.environment['services'] == {
      'A': { '0': { 'first-seen': mock.ANY, 'last-seen': mock.ANY, 'status': se.S_HOLD, 'tag': '0', 'service': 'A', 'status-set': mock.ANY },
             '1': { 'first-seen': mock.ANY, 'last-seen': mock.ANY, 'status': se.S_HOLD, 'tag': '1', 'service': 'A', 'status-set': mock.ANY },
           },
      'B': { '2': { 'first-seen': mock.ANY, 'last-seen': mock.ANY, 'status': se.S_HOLD, 'tag': '2', 'service': 'B', 'status-set': mock.ANY },
  ...
  assert se.environment['instances'] == {
      '0': { 'first-seen': mock.ANY, 'last-seen': mock.ANY, 'status': se.S_HOLD, 'tag': '0', 'service': 'A', 'status-set': mock.ANY },
      '1': { 'first-seen': mock.ANY, 'last-seen': mock.ANY, 'status': se.S_HOLD, 'tag': '1', 'service': 'A', 'status-set': mock.ANY },
      '2': { 'first-seen': mock.ANY, 'last-seen': mock.ANY, 'status': se.S_HOLD, 'tag': '2', 'service': 'B', 'status-set': mock.ANY },
      '3': { 'first-seen': mock.ANY, 'last-seen': mock.ANY, 'status': se.S_HOLD, 'tag': '3', 'service': 'B', 'status-set': mock.ANY },
  }
