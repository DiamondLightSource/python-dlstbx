...
known_wrappers = [  # please keep alphabetically sorted
    ...
    "fast_ep_setup = dlstbx.wrapper.fast_ep_setup:FastEPSetupWrapper",
    "fast_ep_run = dlstbx.wrapper.fast_ep_run:FastEPRunWrapper",
    "fast_ep_report = dlstbx.wrapper.fast_ep_report:FastEPReportWrapper",
    ...
    "mrbump_setup = dlstbx.wrapper.mrbump_setup:MrBUMPSetupWrapper",
    "mrbump_run = dlstbx.wrapper.mrbump_run:MrBUMPRunWrapper",
    "mrbump_report = dlstbx.wrapper.mrbump_report:MrBUMPReportWrapper",
